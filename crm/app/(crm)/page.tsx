    ...
    <>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        <section className="card p-5">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link href="/calendar" className="text-xs text-gold hover:text-gold-hover">
              Calendar →
            </Link>
          </div>
        ...
        <section className="card p-5">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link href="/activities" className="text-xs text-gold hover:text-gold-hover">
              All activity →
            </Link>
          </div>
      ...
      <section className="card mt-6 p-5">
        <div className="mb-4 flex items-center justify-between">
          ...
          <Link href="/tasks" className="text-xs text-gold hover:text-gold-hover">
            All tasks →
          </Link>
        </div>
        {dueTasks.length === 0 ? (
